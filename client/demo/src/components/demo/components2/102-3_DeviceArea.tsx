...
export const DeviceArea = (_props: DeviceAreaProps) => {
    ...
    useMemo(() => {
        messageBuilderState.setMessage(__filename, "audio", { 
            zh: "音频", 
            ja: "オーディオ", 
            ko: "오디오", 
            en: "Audio" 
        });
        messageBuilderState.setMessage(__filename, "reload", { 
            zh: "重新加载", 
            ja: "リロード", 
            ko: "다시 로드", 
            en: "Reload" 
        });
        messageBuilderState.setMessage(__filename, "client", { 
            zh: "客户端", 
            ja: "クライアント", 
            ko: "클라이언트", 
            en: "Client" 
        });
        messageBuilderState.setMessage(__filename, "server", { 
            zh: "服务器", 
            ja: "サーバー", 
            ko: "서버", 
            en: "Server" 
        });
        messageBuilderState.setMessage(__filename, "input", { 
            zh: "输入", 
            ja: "入力", 
            ko: "입력", 
            en: "Input" 
        ...
        messageBuilderState.setMessage(__filename, "monitor", { 
            zh: "监听", 
            ja: "モニター", 
            ko: "모니터", 
            en: "Monitor" 
        });
        messageBuilderState.setMessage(__filename, "none", { 
            zh: "无", 
            ja: "なし", 
            ko: "없음", 
            en: "None" 
        });
        messageBuilderState.setMessage(__filename, "capture", { 
            zh: "捕获", 
            ja: "キャプチャ", 
            ko: "캡처", 
            en: "Capture" 
        });
        messageBuilderState.setMessage(__filename, "cannotChangeMode", {
            zh: "启用语音转换时无法更改模式",
            ja: "音声変換が有効な場合、モードを変更できません",
            ko: "음성 변환이 활성화된 경우 모드를 변경할 수 없습니다",
            en: "Cannot change mode when voice conversion is enabled"
        });
        messageBuilderState.setMessage(__filename, "rec", {
            zh: "录制",
            ja: "録音",
            ko: "녹음",
            en: "REC."
        });
        messageBuilderState.setMessage(__filename, "sampleRate", {
            zh: "采样率",
            ja: "サンプルレート",
            ko: "샘플 레이트",
            en: "S.R."
        ...
        messageBuilderState.setMessage(__filename, "all", { 
            zh: "全部", 
            ja: "すべて", 
            ko: "모두", 
            en: "ALL" 
        });
        messageBuilderState.setMessage(__filename, "file", { 
            zh: "文件", 
            ja: "ファイル", 
            ko: "파일", 
            en: "file" 
        });
        messageBuilderState.setMessage(__filename, "screen", { 
            zh: "屏幕", 
            ja: "画面", 
            ko: "화면", 
            en: "screen" 
        });
        messageBuilderState.setMessage(__filename, "desktop", { 
            zh: "桌面", 
            ja: "デスクトップ", 
            ko: "데스크톱", 
            en: "desktop" 
        });
        messageBuilderState.setMessage(__filename, "useDefault", { 
            zh: "使用默认", 
            ja: "デフォルトを使用", 
            ko: "기본값 사용", 
            en: "use default" 
    ...
    const deviceModeRow = useMemo(() => {
        if (webEdition) {
            return (
                <div className="config-sub-area-control">
                    <div className="config-sub-area-control-title">{messageBuilderState.getMessage(__filename, "audio")}:</div>
                    <div className="config-sub-area-control-field">
                        <div className="config-sub-area-buttons">
                            <div onClick={reloadDeviceInfo} className="config-sub-area-button">
                                {messageBuilderState.getMessage(__filename, "reload")}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        const onDeviceModeChanged = (val: number) => {
            if (isConverting) {
                    alert(messageBuilderState.getMessage(__filename, "cannotChangeMode"));
                    return;
                }
                ...
                <div className="config-sub-area-control-field">
                    <div className="config-sub-area-noise-container">
                        <div className="config-sub-area-noise-checkbox-container">
                            ...
                            />{" "}
                            <label htmlFor="client-device">{messageBuilderState.getMessage(__filename, "client")}</label>
                        </div>
                        <div className="config-sub-area-noise-checkbox-container">
                            <input
                            ...
                            />
                            <label htmlFor="server-device">{messageBuilderState.getMessage(__filename, "server")}</label>
                        </div>
    ...
    const clientAudioInputRow = useMemo(() => {
        ...
        return (
            <div className="config-sub-area-control">
                <div className="config-sub-area-control-title left-padding-1">{messageBuilderState.getMessage(__filename, "input")}</div>
                <div className="config-sub-area-control-field">
                    <select
                    ...
                    <div className="config-sub-area-control-field-auido-io">
                        ...
                        >
                            <option value="ALL" key="ALL">
                                {messageBuilderState.getMessage(__filename, "all")}
                            </option>
                            {hostAPIOptions}
                        </select>
                        <select
                        ...
                        >
                            ...
                            <option value="-1" key="none">
                                {messageBuilderState.getMessage(__filename, "none")}
                            </option>
                        </select>
                    </div>
                </div>
            ...
            <div className="config-sub-area-control">
                ...
                <div className="config-sub-area-control-field">
                    <div className="config-sub-area-control-field-screen-select">
                        ...
                        >
                            {messageBuilderState.getMessage(__filename, "capture")}
                        </div>
                    </div>
                </div>
            </div>
    ...
    const clientAudioOutputRow = useMemo(() => {
        ...
        return (
            <div className="config-sub-area-control">
                    <div className="config-sub-area-control-title left-padding-1">{messageBuilderState.getMessage(__filename, "output")}</div>
                <div className="config-sub-area-control-field">
                    <select
                        className="body-select"
    ...
    const outputRecorderRow = useMemo(() => {
        ...
        return (
            <div className="config-sub-area-control">
                    <div className="config-sub-area-control-title">{messageBuilderState.getMessage(__filename, "rec")}</div>
                <div className="config-sub-area-control-field">
                    <div className="config-sub-area-buttons">
    ...
    const sampleRateRow = useMemo(() => {
        ...
        return (
            <div className="config-sub-area-control">
                    <div className="config-sub-area-control-title left-padding-1">{messageBuilderState.getMessage(__filename, "sampleRate")}</div>
                <div className="config-sub-area-control-field">
                    <div className="config-sub-area-control-field-auido-io">
                        <select
    ...
    const clientMonitorRow = useMemo(() => {
        ...
        return (
            <div className="config-sub-area-control">
                    <div className="config-sub-area-control-title left-padding-1">{messageBuilderState.getMessage(__filename, "monitor")}</div>
                <div className="config-sub-area-control-field">
                    <select
                        className="body-select"
    ...
    const monitorGainControl = useMemo(() => {
        ...
        return (
            <div className="config-sub-area-control">
                    <div className="config-sub-area-control-title left-padding-2">{messageBuilderState.getMessage(__filename, "gain")}</div>
                <div className="config-sub-area-control-field">
                    <div className="config-sub-area-control-field-auido-io">
