...
export const Portrait = (_props: PortraitProps) => {
    ...
    useMemo(() => {
        ...
        messageBuilderState.setMessage(__filename, "male", { 
            zh: "男性", 
            ja: "男性", 
            ko: "남성", 
            en: "male" 
        });
        messageBuilderState.setMessage(__filename, "female", {
        zh: "女性",
        ja: "女性",
        ko: "여성",
        en: "female"
    });
    messageBuilderState.setMessage(__filename, "vol", {
        zh: "音量",
        ja: "音量",
        ko: "볼륨",
        en: "vol"
    });
    messageBuilderState.setMessage(__filename, "buf", {
        zh: "缓冲",
        ja: "バッファ",
        ko: "버퍼",
        en: "buf"
    });
    messageBuilderState.setMessage(__filename, "res", {
        zh: "响应",
        ja: "応答",
        ko: "응답",
        en: "res"
            ...
            portrait = (
                <>
                    ...
                    <div className="beatrice-portrait-select">
                        ...
                        >
                            {messageBuilderState.getMessage(__filename, "male")}
                        </div>
                        <div
                        ...
                        >
                            {messageBuilderState.getMessage(__filename, "female")}
                        </div>
                    </div>
            ...
            <div className="portrait-area">
                <div className="portrait-container">
                    ...
                    <div className="portrait-area-status">
                        ...
                        <p>
                            {messageBuilderState.getMessage(__filename, "vol")}: <span id="status-vol">0</span>
                    </p>
                    <p>
                        {messageBuilderState.getMessage(__filename, "buf")}: <span id="status-buf">0</span> ms
                    </p>
                    <p>
                        {messageBuilderState.getMessage(__filename, "res")}: <span id="status-res">0</span> ms
                        </p>
                        <p>
